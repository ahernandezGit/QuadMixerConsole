       ...
       // reordering the input. This because the pattern may have been permuted
        ...
        for(int i=0;i<numberSides;i++){
            ...
            for(const int &index : positions)
                cout<<index<<" ";
            cout<<endl;
            cout<<" sidel 0"<<side_indexL[positions[0]]<<", sideR 0"<<side_indexR[positions[0]];
            cout<<" sidel end"<<side_indexL[positions.back()]<<", sideR end"<<side_indexR[positions.back()]<<endl;*/
