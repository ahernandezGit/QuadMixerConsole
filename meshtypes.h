...
class CFace   : public vcg::Face<  MyUsedTypes, vcg::face::VertexRef, vcg::face::FFAdj,vcg::face::VFAdj, vcg::face::Normal3f, vcg::face::EdgePlane, vcg::face::Color4b, vcg::face::BitFlags,face::Mark,face::Qualityf,face::WedgeTexCoord2f> {};
